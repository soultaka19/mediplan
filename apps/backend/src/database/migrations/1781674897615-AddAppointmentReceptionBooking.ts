...
export class AddAppointmentReceptionBooking1781674897615 implements MigrationInterface {
  name = 'AddAppointmentReceptionBooking1781674897615';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Anti-double-réservation (OM-04) : au plus UN rendez-vous actif par créneau.
    // Index unique PARTIEL — un RDV annulé libère le créneau (exclu de l'index),
    // ce qui autorise une nouvelle réservation sur le même créneau.
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX IF EXISTS "uq_appointment_active_slot";`);
