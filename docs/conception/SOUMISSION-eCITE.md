# Soumission eCité — Dossier de conception MediPlan

> À copier-coller dans la zone de remise eCité, après avoir poussé le dépôt sur GitHub.
> Les liens supposent le compte GitHub `soultaka19` ; adaptez si le dépôt est créé ailleurs.

## 1. Liens à soumettre

- **Dépôt GitHub de l'équipe** : https://github.com/soultaka19/mediplan
- **Dossier de conception (lien direct)** : https://github.com/soultaka19/mediplan/tree/main/docs/conception
- **Plan Jira (projet MediPlan)** : https://diallosouleymanetaka.atlassian.net/jira/software/projects/MEDIPLAN/boards

## 2. Fichiers du dossier de conception déposés dans GitHub

Tous situés dans `docs/conception/` :
...
## 3. Conformité avec la consigne (Semaine du 1ᵉʳ juin)
...
## 4. Avant de soumettre — vérifier

1. Le dépôt est poussé sur GitHub et le dossier `docs/conception/` est visible.
2. La professeure `StephanieKa-2022` a bien accès au dépôt GitHub **et** au tableau Jira.
3. Les liens ci-dessus fonctionnent en navigation privée (ou demander confirmation à la prof).
